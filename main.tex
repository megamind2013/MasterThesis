...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % 中文封面内容
  \title{中国科学技术大学\\硕士毕业论文\\修改文档(Beta)}%一般情况下扉页和封皮、书脊共用一个标题文本，可以不用定义\spinetitle （仅硕博有用）, \covertitle（本硕博均有用）和\encovertitle（仅本科有用）。特殊情况见下。
  ...
  \covertitle{中国科学技术大学硕士毕业\\论文文档(Beta)}
